# infrastructure/orchestrator/trigger/setup/start_grafana.py
...
class StartKafkaPipeline(PipelineExecutor):
    pass

async def main():
    pipeline = StartKafkaPipeline(
        config=WorkflowConfig(
            service_name="grafana",
            workflow_name="SetupGrafanaWorkflow",
