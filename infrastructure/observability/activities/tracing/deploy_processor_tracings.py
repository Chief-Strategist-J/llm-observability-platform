...
async def deploy_processor_tracings(params: Dict[str, Any]) -> Dict[str, Any]:
    logger.info("deploy_processor_tracings started with params: %s", params)
    ...
    try:
        ...
        logger.info("deploy_processor_tracings processors_present=%s", processors_deployed)
        return {
            "success": True,
        ...
        logger.exception("deploy_processor_tracings failed: %s", e)
