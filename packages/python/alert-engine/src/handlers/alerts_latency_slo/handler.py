...
class LatencySloAlertHandler:
    ...
    def handle(self, payload: dict[str, Any]) -> None:
        ...
        with tracer.start_as_current_span(
            "latency_slo_alert_handler.handle",
            attributes={
            ...
            if severity == "page":
                ...
                with tracer.start_as_current_span("latency_slo_alert_handler.check_rate_limit") as sub_span:
                ...
                with tracer.start_as_current_span("latency_slo_alert_handler.notify_pagerduty"):
                ...
                with tracer.start_as_current_span("latency_slo_alert_handler.notify_slack"):
                ...
                with tracer.start_as_current_span("latency_slo_alert_handler.insert_database"):
