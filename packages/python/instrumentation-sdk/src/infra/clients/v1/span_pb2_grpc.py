...
class SpanIngestionServiceServicer(object):
    """Service definition for direct gRPC ingestion
    """
...
def add_SpanIngestionServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'llm.observability.v1.SpanIngestionService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class SpanIngestionService(object):
    """Service definition for direct gRPC ingestion
    """
