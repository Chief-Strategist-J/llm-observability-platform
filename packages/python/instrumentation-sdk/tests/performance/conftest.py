...
def pytest_sessionfinish(session, exitstatus):
    if not hasattr(pytest, "performance_metrics"):
        return
    reports_dir = os.path.join(session.config.rootdir, "reports")
    os.makedirs(reports_dir, exist_ok=True)
    metrics_json = json.dumps(pytest.performance_metrics)
...
<body>
  <div class="container">
    ...
    <div class="grid-4">
      <div class="card">
        ...
        <div class="card-subtitle" id="in-memory-sub">--</div>
      </div>
      <div class="card">
        <div class="card-title">WAL Fallback Ingestion</div>
        <div class="card-value blue" id="wal-fallback-val">--</div>
        <div class="card-subtitle" id="wal-fallback-sub">--</div>
      </div>
      <div class="card">
        <div class="card-title">WAL Replay Recovery</div>
    ...
    <div class="table-container">
      <div class="table-header">Test Execution Summary</div>
      <table>
        <thead>
          <tr>
            <th>Scenario</th>
  ...
  <script>
    ...
    rendered = html_template.replace("__METRICS_DATA__", metrics_json)
