...
export function OrgSettingsForm({
  ...
  return (
    <div className="space-y-6 w-full">
      {status && (
        <div className="rounded-xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-3 text-xs text-[hsl(var(--foreground))] shadow">
          {status}
        </div>
      )}
      ...
      <div className="rounded-2xl border border-[hsl(var(--border))] bg-[hsl(var(--card))] p-6 space-y-6">
        <div className="flex items-center justify-between border-b border-[hsl(var(--border))] pb-4">
          ...
          <div className="flex items-center gap-2">
            <span className="rounded-full bg-[hsl(var(--primary)/.15)] px-3 py-1 text-xs font-semibold text-[hsl(var(--primary))]">
              {plan}
            </span>
            <span className="flex items-center gap-1 rounded-full bg-[hsl(var(--muted))] px-3 py-1 text-xs font-semibold text-[hsl(var(--muted-foreground))]">
              <ShieldCheck size={12} />
      ...
      <div className="rounded-2xl border border-[hsl(var(--destructive)/.3)] bg-[hsl(var(--destructive)/.05)] p-6 space-y-3 text-left">
