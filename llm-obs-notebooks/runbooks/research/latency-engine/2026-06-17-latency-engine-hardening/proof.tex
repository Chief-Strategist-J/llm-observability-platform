...
%% ── Input / Output step inline boxes (list-safe) ────────────────────────────
\definecolor{inputgreen}  {RGB}{ 22,120, 60}
\definecolor{inputlightbg}{RGB}{230,248,237}
\definecolor{outputindigo}{RGB}{ 55, 48,163}
\definecolor{outputlightbg}{RGB}{237,236,255}

%% \ioline{color}{bg}{label}{content}
\newcommand{\inputline}[2]{%
  \par\noindent\vspace{2pt}%
  {\small\bfseries\sffamily\color{inputgreen}%
   \rule[0.5ex]{3pt}{8pt}\hspace{4pt}INPUT\enspace\textbar\enspace#1}%
  \par\noindent%
  \setlength{\fboxsep}{4pt}%
  \colorbox{inputlightbg}{\parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{\small #2}}%
  \vspace{2pt}\par%
}
\newcommand{\outputline}[2]{%
  \par\noindent\vspace{2pt}%
  {\small\bfseries\sffamily\color{outputindigo}%
   \rule[0.5ex]{3pt}{8pt}\hspace{4pt}OUTPUT\enspace\textbar\enspace#1}%
  \par\noindent%
  \setlength{\fboxsep}{4pt}%
  \colorbox{outputlightbg}{\parbox{\dimexpr\linewidth-2\fboxsep-2\fboxrule\relax}{\small #2}}%
  \vspace{2pt}\par%
}


%% ── Input / Output step boxes ────────────────────────────────────────────────
\definecolor{inputgreen}  {RGB}{ 22,120, 60}
\definecolor{inputlightbg}{RGB}{230,248,237}
\definecolor{outputindigo}{RGB}{ 55, 48,163}
\definecolor{outputlightbg}{RGB}{237,236,255}
...
\newtcolorbox{inputbox}[1]{%
  enhanced, breakable,
  title       = {\small\bfseries\sffamily $->$\ Input: #1},
  colback     = inputlightbg,
  colframe    = inputgreen,
  colbacktitle= inputgreen,
  coltitle    = white,
  fonttitle   = \bfseries\small,
  arc         = 2mm,
  boxrule     = 0.8pt,
  ...
  boxed title style={arc=1.5mm,boxrule=0.5pt,colframe=inputgreen},
}

\newtcolorbox{outputbox}[1]{%
  enhanced, breakable,
  title       = {\small\bfseries\sffamily $\leftarrow$\ Output: #1},
  colback     = outputlightbg,
  colframe    = outputindigo,
  colbacktitle= outputindigo,
  coltitle    = white,
  fonttitle   = \bfseries\small,
  arc         = 2mm,
  boxrule     = 0.8pt,
  top=3pt, bottom=3pt, left=5pt, right=5pt,
  attach boxed title to top left={yshift=-2mm,xshift=5mm},
  boxed title style={arc=1.5mm,boxrule=0.5pt,colframe=outputindigo},
}
...
\begin{itemize}[leftmargin=*]
  \item[] \textbf{Data Passing:}
    \begin{itemize}
      ...
      \item \textbf{Outputs:} Formatted Config String: \texttt{"maxmemory 512mb{\textbackslash}nttl 300"}.
    \end{itemize}
  \item[] \textbf{Critical \& Meta Questions:}
  \begin{enumerate}
