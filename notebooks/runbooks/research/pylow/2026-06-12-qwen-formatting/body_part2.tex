...
\begin{tikzpicture}[node distance=0.7cm and 1.1cm]
  ...
  \node[mrgblk, right=3.0cm of critic] (upd) {\textbf{PPO} \\ (Update)};
...
\begin{tikzpicture}[node distance=0.5cm and 0.8cm]
  ...
  \node[grayblk, below=1.0cm of b2] (score) {\textbf{Branch} \\ (Scorer $s_\phi$)};
...
\begin{tikzpicture}[node distance=0.7cm and 1.1cm]
  ...
  \node[lossblk, right=4.2cm of backbone] (loss) {\textbf{BT Loss} \\ ($\log\sigma(r_w - r_l)$)};
