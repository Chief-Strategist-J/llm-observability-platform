...
\begin{tikzpicture}[node distance=0.6cm and 1.1cm]
  ...
  \node[trnblk, right=1.6cm of d1] (h1) {\textbf{Head$_1$} \\ ($\theta_1$)};
  \node[trnblk, right=1.6cm of d2] (h2) {\textbf{Head$_2$} \\ ($\theta_2$)};
  \node[trnblk, right=1.6cm of dk] (hk) {\textbf{Head$_K$} \\ ($\theta_K$)};
...
\begin{tikzpicture}[node distance=0.6cm and 1.0cm]
  ...
  \node[lossblk, right=of labels] (loss) {\textbf{Weighted} \\ (SFT Loss)};
