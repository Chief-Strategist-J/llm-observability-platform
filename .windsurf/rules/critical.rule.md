...
- whenever I say save this as memory that time you have to create add in last memory log same formate as change.log ascii tree update location llm-observability-platform/logs/memory.log
